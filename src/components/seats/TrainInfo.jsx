        ...
        <div className='seats__train-details'>
            ...
            <div className='seats__train-route-details'>
                <div className='seats__train-route-item'>
                    <span className='seats__train-route-time'>{getTime(item[route].from.datetime)}</span>
                    <span className='seats__train-route-city'>{item[route].from.city.name}</span>
                    <span className='seats__train-route-station'>{item[route].from.railway_station_name} вокзал</span>
                </div>
                <svg className='seats__train-route-arrow-svg' width='30' height='20' viewBox='0 0 30 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
                ...
                <div className='seats__train-route-item'>
                    <span className='seats__train-route-time'>{getTime(item[route].to.datetime)}</span>
                    <span className='seats__train-route-city'>{item[route].to.city.name}</span>
                    <span className='seats__train-route-station'>{item[route].to.railway_station_name} вокзал</span>
                </div>
            </div>
            <div className='seats__train-time'>
                <svg className='seats__train-time-svg' width='30' height='30' viewBox='0 0 30 30' fill='none' xmlns='http://www.w3.org/2000/svg'>
                    ...
                    <path d='M15.3296 14.3922C17.3571 13.4946 19.1476 12.6762 20.9381 11.8842C21.2278 11.7521 21.5174 11.5145 21.8071 11.5409C22.2284 11.5673 22.6233 11.805 23.0446 11.937C22.8603 12.333 22.8077 12.9138 22.4917 13.0722C21.4648 13.6794 20.3589 14.1546 19.3056 14.6562C17.989 15.2899 16.6725 15.9499 15.3559 16.5571C14.171 17.1115 13.5917 16.7683 13.5654 15.5011C13.5391 12.6762 13.5127 9.85129 13.5917 7.02641C13.5917 6.6304 14.1447 6.23439 14.4343 5.83838C14.7503 6.23439 15.3033 6.604 15.3033 7.00001C15.3822 9.37608 15.3296 11.7521 15.3296 14.3922Z' fill='#FFA800' />
                </svg>
                <span className='seats__train-time-text'>{hours} часов<br />{minutes} минуты</span>
            </div>
        </div>
    )
}
