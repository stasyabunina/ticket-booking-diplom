    ...
    return (
        <div className='seats__coach-seats-list seats__coach-seats-list_fourth'>
            ...
            <div className='seats__coach-seats-left-side'>
                <Seat key={leftSideSeats[0].index} item={leftSideSeats[0]} route={route} coachId={coach._id} price={getPrice(leftSideSeats[0].index, coach, isWifiIncluded, isLinensIncluded)} service={service} couchClass='fourth' />
                ...
                <Seat key={leftSideSeats[leftSideSeats.length - 1].index} item={leftSideSeats[leftSideSeats.length - 1]} route={route} coachId={coach._id} price={getPrice(leftSideSeats[leftSideSeats.length - 1].index, coach, isWifiIncluded, isLinensIncluded)} service={service} />
            </div>
        </div>
    )
}
