...
function TicketsBenefit({ name, inputName }) {
    ...
    return (
        <li className='tickets__benefit'>
            ...
            <input id={inputName} className='tickets__checkbox visually-hidden' type='checkbox' name={inputName} checked={value ? true : false} onChange={() => dispatch(updateCheckedValue(inputName, !value))} />
            <label className='tickets__switch-label' htmlFor={inputName}></label>
        </li>
    )
}
