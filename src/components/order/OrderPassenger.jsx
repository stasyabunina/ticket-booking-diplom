    ...
    return (
        <li className='order__passenger'>
            <div className='order__passenger-type'>
                <svg className='order__passenger-type-svg' width='68' height='68' viewBox='0 0 68 68' fill='none' xmlns='http://www.w3.org/2000/svg'>
            ...
            <div className='order__passenger-info'>
                <span className='order__passenger-fullname'>{item.person_info.first_name} {item.person_info.last_name} {item.person_info.patronymic}</span>
                <div className='order__passenger-info-details'>
                    <span className='order__passenger-details-item'>Пол {item.person_info.gender ? 'мужской' : 'женский'}</span>
                    <span className='order__passenger-details-item'>Дата рождения {getBirthDate(item.person_info.birthday)}</span>
                    <span className='order__passenger-details-item'>{item.person_info.document_type === 'паспорт' ? 'Паспорт РФ' : 'Свидетельство о рождении'} {item.person_info.document_data}</span>
                </div>
            </div>
        </li>
    );
